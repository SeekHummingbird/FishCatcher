...
{    
    ...
    this->setBackgroundBrush(QBrush(QPixmap("img/easysea.png")));
    ...
    score=new Qscore("img/score.png",easyscence);
    score->setPos(this->width()-91 , 85);

    //绘制大炮并增加到场景中
    gun=new QGun("img/gun0.png",easyscence);
    gun->setPos(this->width()/2,this->height());
    //easyscence->addItem(gun);

    fish1=new QFish("img/shark_r1.png",easyscence);
    //fish1->setPos(-130,50);
    //easyscence->addItem(fish1);

    fish2=new QFish("img/shark_r1.png",easyscence);
    //fish2->setPos(-50,150);
    //easyscence->addItem(fish2);

    fish3=new QFish("img/shark_r1.png",easyscence);
    //fish3->setPos(-100,250);
    //easyscence->addItem(fish3);

    fish4=new QFish("img/shark_r1.png",easyscence);
    //fish4->setPos(-80,350);
    //easyscence->addItem(fish4);

    fish5=new QFish("img/shark_r1.png",easyscence);
    //fish5->setPos(150,350);
    //easyscence->addItem(fish5);

    fish6=new QFish("img/shark_r1.png",easyscence);
    //fish5->setPos(150,350);
    //easyscence->addItem(fish5);

    fish7=new QFish("img/shark_r1.png",easyscence);
    //fish5->setPos(150,350);
    //easyscence->addItem(fish5);

    fish8=new QFish("img/shark_r1.png",easyscence);
    //fish5->setPos(150,350);
    //easyscence->addItem(fish5);

    fish9=new QFish("img/shark_r1.png",easyscence);
    //fish5->setPos(150,350);
    //easyscence->addItem(fish5);

    fish10=new QFish2("img/f_r1.jpg",easyscence);
    //fish5->setPos(150,350);
    //easyscence->addItem(fish5);
...
int Easyview::Score=0;

void Easyview::resizeEvent(QResizeEvent* event)
{
    this->setBackgroundBrush(QBrush(QPixmap("img/easysea.png").scaled(event->size(),Qt::IgnoreAspectRatio,Qt::SmoothTransformation)));
}
 ...
 void Easyview::mousePressEvent(QMouseEvent* event)
 {
     if(event->button() == Qt::LeftButton)
     {
         ...
         QBullet* bullet= new QBullet("img/B5.png", easyscence,linef.angle());
...
//     v1->show();
 ...
 void Easyview::advance(int phase)
 {
     std::cout<<"123";
     label->setText(QString("得分：%1").arg(Score));
 }
